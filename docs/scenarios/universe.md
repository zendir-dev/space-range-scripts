...
| `magnetosphere` | `bool` | `false` | If `true`, Earth's magnetic field is modelled. Affects `Magnetometer` telemetry and any magnetorquer-style components. Set `false` to disable magnetic-field effects entirely. |
