...
You are a Space Domain Awareness (SDA) operator team. Your job is to watch, track, image, and classify a field of objects in orbit using two spacecraft you share: a **LEO Overwatch** node for close survey work and a **GEO node** in the geostationary belt near Singapore. You do not command any of the targets. Everything you learn about them comes from your own sensors: the optical camera, the charge coupled device (CCD) imager, and the radar.
...
| --- | --- | --- |
| Mass | 300 kg | 350 kg |
| Orbit | LEO, semi-major axis 9000 km, inclination 51.6 deg | Geostationary, near Singapore |
...
- **Optical Camera:** Visible-light imager for direct inspection of a target once it is in the boresight. This is your imaging tool for the Phase 4 intercept.
- **GPS Sensor:** Position and velocity for your own spacecraft. Both nodes report healthy navigation.
